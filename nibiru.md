...
- **İsteğe bağlı snap kullanabilirsiniz (1,707,942 block)**
...
curl https://snapshots2-testnet.nodejumper.io/nibiru-testnet/nibiru-itn-1_2023-04-07.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.nibid
