...
- **İsteğe bağlı snap kullanabilirsiniz (1,649,382 block)**
...
curl https://snapshots2-testnet.nodejumper.io/nibiru-testnet/nibiru-itn-1_2023-04-06.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.nibid
