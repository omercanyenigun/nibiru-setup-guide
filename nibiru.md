...
- **İsteğe bağlı snap kullanabilirsiniz (1,417,981)**
...
curl https://snapshots2-testnet.nodejumper.io/nibiru-testnet/nibiru-itn-1_2023-03-30.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.nibid
