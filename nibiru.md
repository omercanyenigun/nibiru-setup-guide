...
- **İsteğe bağlı snap kullanabilirsiniz (827,442)**
...
curl https://snapshots2-testnet.nodejumper.io/nibiru-testnet/nibiru-itn-1_2023-03-11.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.nibid
